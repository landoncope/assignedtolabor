...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy policy" updated="September 10, 2026">
      ...
      <ul>
        <li><b>Videos you submit</b>, along with the script you built, the language and team you chose, and the first name you enter, if any.</li>
      ...
      <h2>How we use it</h2>
      <ul>
        <li>Volunteer leads of the team your video goes to watch your video and decide whether to share it.</li>
        <li>If your video is approved, it is posted publicly on that team&rsquo;s social media accounts. By submitting, you agree to that.</li>
      ...
      <p>Videos are private while under review. Only you, the leads of your team, and site administrators can view them. Our data is stored with Supabase and the site is hosted on Vercel.</p>
      <h2>Contact</h2>
